...
public class HibernateConfig {
    ...
    @Value("#{T(evg299.sample.web.dojo.config.PropertiesConfig).slice(properties, 'hibernate.')}")
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "evg299.sample.web.dojo.domain.entities" });
